...
export class GoProBle extends EventTarget{
 ...
 startPolling(){this.stopPolling();this.pollTimer=setInterval(()=>this.queryStatuses().catch(e=>this.diag('status','warn',e.message)),2000)}
