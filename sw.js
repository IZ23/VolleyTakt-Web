...
const OPTIONAL_ASSETS = [
  ...
  './app-icons/techniques/aufschlag.png?v=0.4.0-rc4-r1-pictograms',
  './app-icons/techniques/zuspiel.png?v=0.4.0-rc4-r1-pictograms',
  './app-icons/techniques/angriff.png?v=0.4.0-rc4-r1-pictograms',
  './app-icons/techniques/annahme.png?v=0.4.0-rc4-r1-pictograms',
  './app-icons/techniques/abwehr.png?v=0.4.0-rc4-r1-pictograms',
  './app-icons/techniques/block.png?v=0.4.0-rc4-r1-pictograms',
