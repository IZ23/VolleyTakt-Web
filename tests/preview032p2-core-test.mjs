...
need(app.includes("APP_VERSION='0.4.0 RC4'"),'visible version missing');
need(html.includes('<title>VolleyTakt Live 0.4.0 RC4</title>'),'tab version wrong');
need(html.includes('<small>0.4.0 RC4</small>'),'header version wrong');
need(sw.includes("volleytakt-live-web-v0.4.0-rc4"),'cache version wrong');
need(html.includes('volleytakt-192.png?v=0.4.0-rc4'),'favicon missing');
