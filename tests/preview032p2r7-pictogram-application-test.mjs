...
need(app.includes("TECHNIQUE_ICON_REV='0.4.0-rc2-pictograms'"),'icon asset revision missing');
...
for(const n of ['aufschlag','zuspiel','angriff','annahme','abwehr','block']){
  ...
  need(sw.includes(`./app-icons/techniques/${n}.png?v=0.4.0-rc2-pictograms`),`${n} not cached with revised URL`);
}
