...
need(app.includes("APP_VERSION='0.4.0 RC2'"),'r7 app version');
need(app.includes("APP_VERSION_ID='0.4.0-rc2'"),'r7 app version id');
need(html.includes('<title>VolleyTakt Live 0.4.0 RC2</title>'),'r7 title');
need(sw.includes("volleytakt-live-web-v0.4.0-rc2"),'r7 cache');
