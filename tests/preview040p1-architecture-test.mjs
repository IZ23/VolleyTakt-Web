...
need(app.includes("APP_VERSION='0.4.0 RC1'"),'Preview1 app version missing');
need(html.includes('VolleyTakt Live 0.4.0 RC1'),'Preview1 visible version missing');
need(sw.includes("volleytakt-live-web-v0.4.0-rc1"),'Preview1 cache missing');
...
console.log('0.4.0 RC1 architecture/state regression: OK');
