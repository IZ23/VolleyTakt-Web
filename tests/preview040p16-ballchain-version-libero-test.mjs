...
assert.match(app,/APP_VERSION='0\.4\.0 RC4'/);assert.match(sw,/0\.4\.0-rc4/);assert.doesNotMatch(app,/preview-pill\">0\.3 Preview/);
console.log('rc4-compatible ball-chain/libero/version regression: OK');
