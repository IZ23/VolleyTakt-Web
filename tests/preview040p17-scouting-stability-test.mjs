...
assert.match(css,/0\.4\.0 RC1 — scouting-state clarity and quality layout regression guard/);
...
assert.match(app,/APP_VERSION='0\.4\.0 RC1'/);
assert.match(sw,/0\.4\.0-rc1/);
console.log('rc1-compatible scouting stability regression: OK');
