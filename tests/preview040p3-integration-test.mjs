...
ok(app.includes("APP_VERSION='0.4.0 RC2'"),'app version');
...
ok(index.includes('VolleyTakt Live 0.4.0 RC2'),'index current version');
ok(sw.includes("volleytakt-live-web-v0.4.0-rc2"),'service worker cache');
ok(sw.includes("'./js/scouting/rally.js'"),'rally module offline cached');
ok(manifest.name==='VolleyTakt Live 0.4.0 RC2','manifest version');
ok(update.version==='0.4.0 RC2'&&update.version_id==='0.4.0-rc2','update manifest version');
