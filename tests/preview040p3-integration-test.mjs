...
ok(app.includes("APP_VERSION='0.4.0 RC4'"),'app version');
...
ok(index.includes('VolleyTakt Live 0.4.0 RC4'),'index current version');
ok(sw.includes("volleytakt-live-web-v0.4.0-rc4"),'service worker cache');
ok(sw.includes("'./js/scouting/rally.js'"),'rally module offline cached');
ok(manifest.name==='VolleyTakt Live 0.4.0 RC4','manifest version');
ok(update.version==='0.4.0 RC4'&&update.version_id==='0.4.0-rc4','update manifest version');
