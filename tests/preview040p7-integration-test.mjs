...
assert.match(app,/0\.4\.0 RC4/);assert.match(app,/serviceWorker\.register\('\.\/sw\.js\?v=0\.4\.0-rc4'/);assert.match(sw,/scouting\/history\.js/);assert.match(sw,/0\.4\.0-rc4/);assert.match(idx,/0\.4\.0 RC4/);
