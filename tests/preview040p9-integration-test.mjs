...
assert.match(app,/0\.4\.0 RC3/);assert.match(app,/0\.4\.0-rc3/);
assert.match(sw,/analysis\/domain\.js/);assert.match(sw,/analysis\/ui\.js/);assert.match(sw,/0\.4\.0-rc3/);assert.match(index,/0\.4\.0 RC3/);
