...
assert.match(app,/0\.4\.0 RC4/);assert.match(app,/0\.4\.0-rc4/);
assert.match(sw,/analysis\/domain\.js/);assert.match(sw,/analysis\/ui\.js/);assert.match(sw,/0\.4\.0-rc4/);assert.match(index,/0\.4\.0 RC4/);
